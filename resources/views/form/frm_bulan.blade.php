...
<form id="frmBulan" class="form-horizontal" action="{{ url('bulan/save') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="hidden" name="kd_bulan" value="{{ $bulan['kd_bulan'] }}">
                            <input type="text" class="form-control" id="nama_bulan" placeholder="Nama Bulan" name="nama_bulan" value="{{ $bulan['nama_bulan'] }}">
                        </div>
                    </div>    
                </div>
